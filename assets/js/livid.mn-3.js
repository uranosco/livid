var showcaseCTA = {
  adminUrl: "https://websitedemos.net/archmasters-architecture-02/wp-admin/",
  networkSiteURL: "https://websitedemos.net/",
  templateName: "ArchMasters Architecture",
  isMainSite: "",
  templateColorScheme: "dark",
  path: "/archmasters-architecture-02/",
  ...
  customizerData: {
    "astra-settings": {
      ...
      "ast-dynamic-single-post-metadata": ["comments", "author", "date"],
      ...
      "theme-button-padding": {
        desktop: { top: "30", right: "80", bottom: "30", left: "80" },
        tablet: { top: "25", right: "50", bottom: "25", left: "50" },
      ...
      "ast-header-retina-logo":
        "https://websitedemos.net/archmasters-architecture-02/wp-content/uploads/sites/1196/2023/03/logo-retina.png",
      ...
      "display-site-title-responsive": { desktop: 0, tablet: 0, mobile: 0 },
      ...
      "body-text-transform": "",
      "headings-font-family": "'Forum', display",
      ...
      "hb-header-main-sep-color": "var(--ast-global-color-6)",
      ...
      "header-mobile-menu-menu-spacing": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "10", right: "20", bottom: "10", left: "20" },
        mobile: { top: "", right: "", bottom: "", left: "" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "px",
      ...
      "section-primary-footer-builder-padding": {
        desktop: { top: "3", right: "6.5", bottom: "5", left: "6.5" },
        tablet: { top: "5", right: "1", bottom: "7", left: "1" },
        mobile: { top: "15", right: "0", bottom: "12", left: "0" },
        "desktop-unit": "%",
        "tablet-unit": "%",
        "mobile-unit": "%",
      },
      ...
      "header-button1-text-color": { desktop: "", tablet: "", mobile: "" },
      "header-button1-back-color": { desktop: "", tablet: "", mobile: "" },
      "header-button1-text-h-color": { desktop: "", tablet: "", mobile: "" },
      "header-button1-back-h-color": { desktop: "", tablet: "", mobile: "" },
      ...
      "footer-social-1-space": { desktop: "", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-4": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-5": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-6": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-7": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-8": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-9": { desktop: "left", tablet: "", mobile: "" },
      ...
      "footer-widget-alignment-10": { desktop: "left", tablet: "", mobile: "" },
      ...
      "section-header-builder-layout-margin": {
        desktop: { top: "", right: "6.5", bottom: "", left: "6.5" },
        tablet: { top: "", right: "6", bottom: "", left: "6" },
        mobile: { top: "0", right: "6", bottom: "0", left: "6" },
        "desktop-unit": "%",
        "tablet-unit": "%",
        "mobile-unit": "%",
      },
      ...
      "section-below-footer-builder-padding": {
        desktop: { top: "0", right: "6.5", bottom: "0", left: "6.5" },
        tablet: { top: "0", right: "1", bottom: "0", left: "1" },
      ...
      "header-mobile-menu-submenu-item-b-color": "var(--ast-global-color-6)",
      ...
      "header-account-logout-link": {
        url: "https://websitedemos.net/archmasters-architecture-02/wp-login.php",
        new_tab: false,
        link_rel: "",
      },
      ...
      "button-preset-style": "button_04",
      "button-radius": 0,
      "different-retina-logo": true,
      "hbb-inner-spacing": { desktop: 0, tablet: 0 },
      "hb-inner-spacing": { desktop: 10, mobile: 0, tablet: 0 },
      "astra-sidebar-widgets-footer-widget-2-margin": {
        desktop: { top: "", right: "", bottom: "", left: "" },
        tablet: { top: "", right: "", bottom: "", left: "" },
        mobile: { top: "10", right: "0", bottom: "10", left: "0" },
        "desktop-unit": "px",
        "tablet-unit": "px",
        "mobile-unit": "%",
      },
